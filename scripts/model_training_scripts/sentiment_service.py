...
sentiment_model_path = "data/models/sentiment/saribasmetehan_sentiment_model"  # BERT modelinizin yolu
...
contractions_path = 'data/json/contractions.json'
stopwords_path = 'data/json/stopwords.json'
